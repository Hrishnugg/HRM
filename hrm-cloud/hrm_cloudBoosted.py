...
app = modal.App("hrm-b200-final-boosted")
...
CONFIG = {
    ...
    "data_episodes": 30000, 
    "batch_size": 2048,     # Distributed across 2 GPUs
...
@app.function(image=image, gpu="B200", volumes={"/data": vol}, timeout=7200)
def train_models(chunk_files: List[str]):
    ...
    # Parallel loading: ~3-5x faster than sequential
    ...
    print("Training LSTM Baseline (Single GPU + AMP)...")
    ...
    print("Training HRM (Single GPU + AMP + Scheduled)...")
    ...
    for ep in range(CONFIG['epochs']):
        ...
        for bx, by in dl:
            ...
            # CLIPPING: Critical for stability (unscale first for proper clipping)
